		...
		<form action="{{URL('FormController/insertReklame')}}" method="POST">
			...
			<div class="row">
				<div class="input-field col s4">
					{{--isi dari div--}}
					<input readonly id="nilaipajak" type="text" class="validate autofill" name="nilaipajak">
					{{-- <label for="NilaiPajak">Nilai Pajak</label> --}}
				</div>
				<div class="input-field col s4">
					{{--isi dari div--}}
					<input readonly id="prosentasepajak" type="text" class="validate" name="prosentasepajak">
			...
			<div class="row">
				...
				<div class="input-field col s4">
					{{--isi dari div--}}
					<input readonly id="satuan" type="text" class="validate autofill" name="satuan">
			...
			<div class="row">
				...
				<div class="input-field col s4">
					...
					<input readonly id="kodezona" type="text" class="validate" name="kodezona">
				</div>
				<div class="input-field col s4">
					{{--isi dari div--}}
					<input readonly id="nilaistrategis" type="text" class="validate autofill" name="nilaistrategis">
			...
			<div class="row" hidden>
				<div class="input-field col s2">
                    ...
                    <input readonly id="noid" type="text" class="validate" name="noid">
				</div>
				<div class="input-field col s2">
					{{--isi dari div--}}
					{{-- <label for="disabled">rekeninginduk</label> --}}
                    <input readonly id="rekeninginduk" type="text" class="validate" name="rekeninginduk">
				</div>
				<div class="input-field col s2">
					{{--isi dari div--}}
					{{-- <label for="disabled">JenisPajak</label> --}}
                    <input readonly id="jenispajak" type="text" class="validate" name="jenispajak">
				</div>
				<div class="input-field col s2">
					{{--isi dari div--}}
					{{-- <label for="disabled">JenisPajak</label> --}}
                    <input readonly id="koderuasjalan" type="text" class="validate" name="koderuasjalan">
				</div>
			</div>
            <div class="row">
